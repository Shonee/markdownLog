...
void worker_DoWork(object sender, DoWorkEventArgs e)
{
    ...
    SaveSingleNewNotClose();//需要使用异步线程操作的内容，里面带有进度参数更新
}
//异步线程进度报告
void worker_ProgressChanged(object sender, ProgressChangedEventArgs e)
{
    ...
    {
        splashScreenManager1.SetWaitFormDescription(string.Format("共 {0} 条数据，正在处理第 {1} 条", Count, e.ProgressPercentage));//多线程使用waitform窗体
    }
}
//异步线程完成时事件
